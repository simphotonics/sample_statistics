...
import 'package:statistics/src/exceptions/empty_iterable.dart';

import 'density_functions.dart';
import 'utility_functions.dart';

/// Provides access to basic statistical entities of a
/// numeric sample backed by an iterator.
class SampleStatistics {
  SampleStatistics(this.sample)
  ...
  num get stdDev {
    if (sample.length < 2) {
      throw ExceptionOf<SampleStatistics>(
